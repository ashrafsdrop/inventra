    ...
    <main className="min-h-screen bg-[#f4f6fb] text-[#0a0d14]">
      ...
      <div className="lg:pl-72 flex flex-col min-h-screen">
        ...
        <header className="sticky top-0 z-30 border-b border-[rgba(0,0,0,0.06)] bg-white px-4 py-4 md:px-8 flex items-center justify-between">
          <h1 className="font-['Poppins',sans-serif] text-xl font-bold tracking-tight text-[#0a0d14]">Accounts</h1>
          <button 
          ...
          <div className="w-full">
            <table className="w-full text-left text-sm whitespace-nowrap">
              <thead className="border-b border-[rgba(0,0,0,0.04)] text-[10px] font-bold uppercase tracking-[0.1em] text-[#6b7280]">
                <tr>
                  <th className="py-4 font-semibold w-24">ID</th>
                  <th className="py-4 font-semibold">ACCOUNT</th>
                  <th className="py-4 font-semibold text-center">ACCOUNT TYPE</th>
      ...
      {/* Centered Modal: Create Account */}
      {isDrawerOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm transition-opacity">
          <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl flex flex-col animate-[fadeIn_0.2s_ease-out] m-4">
            {/* Modal Header */}
            <div className="flex items-center border-b border-[rgba(0,0,0,0.06)] px-6 py-4">
              ...
              <h2 className="font-semibold text-[#0a0d14] text-lg">Create Account</h2>
            </div>

            {/* Modal Body */}
            <div className="p-8">
              <h3 className="text-xl font-bold text-center text-[#0a0d14] mb-8">Add Account</h3>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label className="block text-sm mb-2 text-[#f43f5e]">
                    * <span className="text-[#f43f5e]">Account Type</span>
                  </label>
                  <select
                    value={accountType}
                    onChange={(e) => setAccountType(e.target.value)}
                    className="w-full rounded-lg border border-[rgba(0,0,0,0.08)] bg-[#f4f6fb] px-4 py-2.5 text-sm outline-none transition focus:border-[#4f6ef7] focus:bg-white appearance-none cursor-pointer"
                  >
                ...
                <div className="pt-4 flex justify-center">
                  <button className="cursor-pointer rounded-lg border-none bg-[#4f6ef7] px-6 py-2.5 text-sm font-semibold text-white shadow-lg shadow-[#4f6ef7]/25 transition hover:bg-[#3d5ce6]">
                    Add New Account
                  </button>
                </div>
              </div>
